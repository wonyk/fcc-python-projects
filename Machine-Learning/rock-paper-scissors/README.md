...
The file `RPS.py` shows an example function that you will need to update. The example function is defined with one argument (`player(prev_play)`). The `opponent_history` global variable is used to keep track of the opponent_history.
